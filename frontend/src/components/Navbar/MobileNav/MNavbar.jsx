      ...
      <div className="fixed top-0 left-0 right-0 z-40 bg-transparent h-16 flex items-center justify-between px-4 lg:hidden">
        <div className="flex items-center gap-2">
          <Button
            ...
            className="[&_svg]:size-7 text-white drop-shadow-lg hover:bg-white/10"
          >
            <Menu />
          </Button>
          <Link
            to="/"
            className="text-xl font-extrabold tracking-tighter text-white drop-shadow-lg py-1"
          >
            ON U
          </Link>
        </div>
        ...
        <div className="flex items-center gap-0">
          ...
          <Button
            ...
            size="icon"
            asChild
            className="relative [&_svg]:size-7 text-white drop-shadow-lg hover:bg-white/10"
          >
            <Link to="/my_wishlist">
              <Heart />
              ...
              <nav className="space-y-1">
                ...
                <div>
                  <MenuItem
                    ...
                    icon={
                      <ChevronRight
                        className={`w-4 h-4 transition-transform ${showShopMenu ? "rotate-90" : ""}`}
                      />
                    }
                  />
                  {showShopMenu && (
                ...
                <MenuItem
                  label="New Arrivals"
                  onClick={() => {
                    navigation("/products?sortBy=newest");
                    handleMenuClose();
                  }}
                />
                <MenuItem
