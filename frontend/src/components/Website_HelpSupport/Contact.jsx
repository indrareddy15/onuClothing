...
const Contact = () => {
  ...
  const fetchContactUsPageData = async () => {
    ...
    try {
      const res = await axios.get(
        `${BASE_API_URL}/api/common/website/contact-us`,
      );
  ...
  const sendContactQuery = async () => {
    ...
    try {
      const res = await axios.post(
        `${BASE_API_URL}/api/common/website/send-contact-query`,
        { contactDetails: sendingFormData, message: sendingMessage },
      );
      if (res?.data?.Success) {
        checkAndCreateToast(
          "success",
  ...
  return (
    <div
      ...
      className="min-h-screen bg-background overflow-y-auto scrollbar-thin scrollbar-track-muted scrollbar-thumb-border"
    >
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <header className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              {formData.subheader ||
                "We would love to hear from you! Whether it's an inquiry, feedback, or support, reach out to us."}
            </p>
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="bg-card border border-border rounded-2xl p-8 shadow-sm">
              ...
              {formData &&
                ...
                formData.formDataForContactUs.length > 0 && (
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <p className="text-xs text-muted-foreground">
                      ...
                      By submitting this form, you hereby authorise us to
                      contact you through SMS, WhatsApp, RCS Emails and any
