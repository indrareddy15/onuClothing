...
import {
  addItemArrayBag,
  createAndSendProductsArrayWishList,
    ...
    try {
      ...
      if (success) {
        ...
        navigation("/verifying", {
          state: { email: result.email, phoneNumber: result.phoneNumber },
        });
      } else {
      ...
      <div className="absolute inset-0 lg:static lg:w-1/2 bg-black text-white flex flex-col justify-end items-center p-12 pb-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-md text-center hidden lg:block">
          <h1 className="text-5xl font-bold mb-6 tracking-tight">
            Hey, welcome back to ON U ✨
          </h1>
          <p className="text-xl text-gray-200 mb-8">
            Explore new vibes, trending fits, and curated picks made just for
            you.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 relative z-10 overflow-y-auto h-full">
        <div className="w-full max-w-md space-y-8 bg-black/30 backdrop-blur-xl lg:bg-white p-8 rounded-[2rem] lg:rounded-2xl shadow-2xl lg:shadow-none border border-white/10 lg:border-none">
          <div className="text-center lg:text-left">
            <h2 className="text-3xl font-bold text-white lg:text-gray-900 tracking-tight">
            ...
            <p className="mt-2 text-sm text-gray-300 lg:text-gray-600">
              ...
              <Link
                to="/registeruser"
                className="font-medium text-white lg:text-black hover:underline"
              >
          ...
          <form onSubmit={continues} className="mt-8 space-y-6">
            <div className="space-y-4">
              <div className="space-y-2">
                <Label
                  htmlFor="loginInput"
                  className="text-sm font-medium text-gray-300 lg:text-gray-700"
                >
            ...
            <div className="flex items-center justify-between text-sm">
              <div className="flex items-center">
                ...
                <label
                  htmlFor="remember-me"
                  className="ml-2 block text-white lg:text-gray-900"
                >
                  Remember me
                </label>
              </div>
              <div className="text-sm">
                <Link
                  to="/contact"
                  className="font-medium text-gray-300 lg:text-gray-600 hover:text-white lg:hover:text-black"
                >
                  Need help?
                </Link>
              </div>
            ...
            <p className="text-xs text-center text-gray-400 lg:text-gray-500 mt-8">
              ...
              <Link
                to="/tc"
                className="underline hover:text-white lg:hover:text-gray-900"
              >
                Terms of Service
              </Link>{" "}
              and{" "}
